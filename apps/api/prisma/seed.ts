...
async function main() {
  ...
  const settings: Record<string, string> = {
    ...
    hero_bio:
      'I build reliable, scalable backend systems and automate everything from CI/CD pipelines to cloud infrastructure.',
    about_text:
      'Passionate backend engineer with 5+ years of experience in building distributed systems, REST APIs, and DevOps pipelines. I specialize in Node.js, Go, PostgreSQL, Docker, and Kubernetes.',
    contact_email: email,
  }
  ...
  const experiences = [
    {
      ...
      description:
        'Led backend development for a high-traffic e-commerce platform serving 1M+ users. Migrated monolith to microservices, reducing p99 latency by 40%.',
    ...
    },
    {
      ...
      description:
        'Built the core API from scratch using Node.js and PostgreSQL. Set up CI/CD pipelines with GitHub Actions and deployed on AWS ECS.',
    ...
    },
    {
      ...
      description:
        'Developed REST APIs and maintained PostgreSQL databases for various client projects. First exposure to Docker and infrastructure-as-code.',
  ...
  const projects = [
    {
      ...
      description:
        'A high-performance distributed task queue built with Node.js, Redis, and BullMQ. Supports priority queues, retries, and dead-letter queues. Processes 50k+ jobs/minute in production.',
      liveUrl: null,
    ...
    },
    {
      ...
      description:
        'A Kubernetes operator written in Go that automates PostgreSQL and MongoDB backups. Supports S3, GCS, and Azure Blob storage. Configurable retention policies.',
      liveUrl: null,
    ...
    },
    {
      ...
      description:
        'This very website! Built as a monorepo with Next.js frontend and NestJS API backend. Features an admin CMS for managing content without touching code.',
